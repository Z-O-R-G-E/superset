...
import { PivotTableChartPlugin as PivotTableChartPluginV3 } from '@superset-ui/plugin-chart-pivot-table-paulz';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new PivotTableChartPluginV3().configure({ key: 'pivot_table_v3' }),
